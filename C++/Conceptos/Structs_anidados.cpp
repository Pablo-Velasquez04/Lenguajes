...
struct empleado{
	...
	double salario;
}empleados[2];  //Arreglo de 2 empleados

int main(){
	//Pedimos los datos al usuario (entrada de datos)
	for(int i=0; i<2; i++){  //Con iteración de 2, ya que solo son 2 empleados declarados arriba
	...
	//Imprimiendo todos los datos de los empleados
	for(int i=0; i<2; i++){
